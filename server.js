...
// ===== SUPA — JUU KABISA — FIX YA "Cannot access 'supa' before initialization" =====
...
// SERVICE_KEY stays on server only — bypasses RLS securely
...
app.get('/api/health',(req,res)=>res.json({ok:true,os:'18.0 1000+ SCALED SECURED FINAL',secured:true,scaled:true,supa_top_fixed:true,time:new Date().toISOString()}));
...
// ===== FIX YA SCREENSHOT YAKO YA "No open HTTP ports" — LAZIMA 0.0.0.0 =====
app.listen(PORT, '0.0.0.0', ()=>{
  console.log(`🚀 FINAL SCALED SECURED on 0.0.0.0:${PORT} — supa on top fixed — ready for 1000+ hotels`);
});
